    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">โปรแกรมขายของ</div>
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    <div class="container-fluid">
                        <button class="btn btn-primary" id="sidebarToggle">ปิด/เปิด Menu</button>
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                              $id = $row["user_id"];
                              echo '<a href="userupdateform.php?id='.$id.'">แก้ไข</a>';
                              echo " ";
                              echo '<a href="userdelete.php?id='.$id.'">ลบ</a>';
                              echo $row["username"]." ".$row["password"]." ".$row["fullname"];
                              echo " ";
                              echo "<br>";
                            }
                          } else {
